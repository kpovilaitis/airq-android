...
class RemoteAddStationUseCase @Inject constructor(
    private val airQualityDao: AirQualityDao,
    private val airQualityApi: AirQualityApi
) : AddStationUseCase {

    override suspend operator fun invoke(stationId: Int): AddStationUseCase.Result =
        airQualityApi.call {
            ...
            if (airQualityEntity != null) {
                ...
                AddStationUseCase.Result.Success
            } else {
                AddStationUseCase.Result.Error
            }
        }
